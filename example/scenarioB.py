"""Scenario: B, just_glow — 10 FP + GDC + bake.

10 DT flat-top pulses, then 2-day glow discharge cleaning,
then baking at 493 K.
...
scenario = Scenario(pulses=[fp, gdc, bake], baking_temp=273.15 + 220)  # 220 °C in Kelvin
