...
ion_flux_tot = np.full(64,2.5e+18)
atom_flux_tot = np.full(64,0.0)
E_ion_tot = np.full(64,240)
E_atom_tot = np.full(64,0.0)
alpha_ion_tot = np.full(64,90.0)
alpha_atom_tot = np.full(64,0.0)
heat_tot = np.full(64,0.0) # don't need to worry about ion heat because it's all being set to 0 anyways
